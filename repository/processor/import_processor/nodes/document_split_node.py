...
from repository.utils.markdown_util import MarkdownTableLinearizer
...
class DocumentSplitNode(BaseNode):
    ...
    def _split_long_section(self, section: Dict[str, Any], max_content_length: int) -> List[Dict[str, Any]]:
        ...
        # 6.1 切分器对象  # 1. chunk_size:chunk块的大小  2.chunk_overlap块与块之间的重叠的字符数
...
if __name__ == '__main__':
    ...
    md_path = r"D:\Project\llm-project\RAG_repository\repository\processor\import_processor\temp\万用表RS-12的使用\auto\万用表RS-12的使用_new.md"
